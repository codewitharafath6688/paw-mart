...
const Accesories = () => {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold text-center mt-5">Pet Accessories</h2>
            ...
            <div>
              <div>
                <img
                  ...
                  src={ad.pet_accessories.image}
                />
              </div>
              <h3 className="mt-3 font-bold">{ad.pet_accessories.name}</h3>
              <p className="mt-3 font-semibold">$ {ad.pet_accessories.price}</p>
              <button
