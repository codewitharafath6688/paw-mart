...
const CareProdcuts = () => {
      ...
      .then((data) => {
        ...
        if (data.insertedId) {
          ...
          Swal.fire({
            ...
            showConfirmButton: false,location,
            timer: 1500,
          });
        }
      });
  ...
  return (
    <div>
      <h2 className="text-xl font-bold text-center mt-5">Pet Care Products</h2>
            ...
            <div>
              <div>
                <img
                  ...
                  src={ad.pet_care_products.image}
                />
              </div>
              <h3 className="mt-3 font-bold">{ad.pet_care_products.name}</h3>
              <p className="mt-3 font-semibold">$ {ad.pet_care_products.price}</p>
              <button
