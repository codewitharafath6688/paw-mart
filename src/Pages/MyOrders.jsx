...
const MyOrders = () => {
  ...
  const exportPDF = () => {
    ...
    autoTable(doc , {
      ...
      startY: 30,
      styles: { fontSize: 10 },
      headStyles: { fillColor: [166, 66, 89] }, // your theme color
    });
  ...
  return (
    <div className="w-11/12 min-h-[269px] mx-auto my-10">
      <div className="flex justify-end mb-4">
        <button onClick={exportPDF} className="btn bg-[#a64259] text-white">
          Export PDF
        </button>
      </div>
        ...
        <table className="table w-full">
          <thead className=" bg-gray-100">
            <tr>
              ...
              <th className="text-[#a64259]">Pet Name / Product Name</th>
              <th className="text-[#a64259]">Price</th>
              <th className="text-[#a64259]">Date</th>
      ...
      <div className="md:hidden flex flex-col gap-5">
        {list.map((listed, index) => (
          ...
          >
            ...
            <p>
              <span className="font-bold">Buyer:</span> {listed.buyerName}
            </p>
            <p>
              <span className="font-bold">Email:</span> {listed.buyerEmail}
            </p>
            <p>
              <span className="font-bold">Quantity:</span> {listed.quantity}
            </p>
            <p>
              <span className="font-bold">Location:</span> {listed.location}
            </p>
            <p>
            ...
            <p>
              <span className="font-bold">Date:</span> {listed.date}
            </p>
